...
import MembasuhWajahData from "@/constants/membasugwajah";
          ...
          return (
            ...
            >
              ...
              {Array.isArray(item.deskripsi) && (
                <motion.ul
                  className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300 border-b border-blue-500"
                  initial="hidden"
                  animate={inView ? "visible" : "hidden"}
                  variants={fadeUpVariants}
                >
